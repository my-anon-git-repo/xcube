...
- [⚠️ The 2.8M-label problem (read before a full-scale run)](#️-the-28m-label-problem-read-before-a-full-scale-run)
...
Given the above, a sample for this pipeline isn't just "fewer rows" — it
